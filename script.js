...
function updateTimeSlots() {
    ...
    // Define available time slots - Same hours everyday (12:00-22:00)
...
function getOpeningHours(dayOfWeek) {
    // Opening hours: Everyday 12:00-22:00 Including Tuesday
    const hours = {
        1: { open: 12, close: 22 }, // Monday
        2: { open: 12, close: 22 }, // Tuesday - NOW OPEN
...
function isRestaurantOpen(ukTime) {
    ...
    // Restaurant is now open every day
...
function getNextOpeningTime(ukTime) {
    ...
    // Find next open day (restaurant is open every day now)
...
function updateOpeningHoursDisplay() {
    ...
    if (contactHoursElement && contactHoursElement.textContent === 'Opening Hours') {
        ...
        hoursContainer.innerHTML = `
            ...
            <p><strong>Everyday: 12:00 — 22:00</strong><br>
            <span style="color: #28a745; font-weight: bold;">Including Tuesday</span><br>
            <small class="text-muted">Open 7 days a week</small><br>

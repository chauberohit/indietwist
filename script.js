...
function getOpeningHours(dayOfWeek) {
    // Opening hours: Monday, Wednesday-Sunday 12:00-22:00 (Closed Tuesday)
    const hours = {
...
function getNextOpeningTime(ukTime) {
    ...
    // Find next open day (skip closed days)
...
function updateOpeningHoursDisplay() {
    ...
    if (contactHoursElement && contactHoursElement.textContent === 'Opening Hours') {
        ...
        hoursContainer.innerHTML = `
            ...
            <p><strong>Mon, Wed-Sun: 12:00 — 22:00</strong><br>
            <span style="color: #dc3545; font-weight: bold;">Closed Tuesday</span><br>
            <small class="text-muted">Open 6 days a week</small><br>
